...
(function (window, undefined) {
    ...
    function getTranslation() { return localStorage.getItem('bs_translation') || 'luther1545'; }
    ...
    window.Asc.plugin.init = function () {
        ...
        if (!document.getElementById('bs-root')) {
            ...
            root.innerHTML = [
                ...
                '    <option value="luther1545">Luther 1545 (Deutsch)</option>',
                '    <option value="elberfelder1905">Elberfelder 1905 (Deutsch)</option>',
                '    <option value="elberfelder">Elberfelder 1871 (Deutsch)</option>',
                '    <option value="schlachter">Schlachter 1951 (Deutsch)</option>',
            ...
            trlEl.value = localStorage.getItem('bs_translation') || 'luther1545';
